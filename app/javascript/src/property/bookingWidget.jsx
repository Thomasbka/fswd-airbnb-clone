    ...
    return (
      <div className="border p-4 mb-4">
        <form onSubmit={this.submitBooking}>
            ...
            <DateRangePicker
              ...
              isDayBlocked={
                focusedInput === 'startDate'
                  ? this.isStartDateBlocked
                  : this.isEndDateBlocked
              }
              numberOfMonths={1}
            />
          </div>
          ...
          <button type="submit" className="btn btn-large btn-danger btn-block" disabled={!startDate || !endDate}>
            Book
          </button>
        </form>
      </div>
